...
|------|--------------|------|----------|
| **IP Printer** | Stands in for up to 15 ESC/POS receipt printers on loopback IPs, so a POS can print to screen instead of hardware. | [Documentation](tools/ip-printer/) · [Changelog](tools/ip-printer/CHANGELOG.md) | [Releases](https://github.com/mbundgaard/muneris-tools/releases?q=ip-printer&expanded=true) |

_More tools will be added here over time._

## Releases

Every tool version is published as a [GitHub Release](https://github.com/mbundgaard/muneris-tools/releases).
...
releases, filter by its slug — e.g. [`?q=ip-printer`](https://github.com/mbundgaard/muneris-tools/releases?q=ip-printer&expanded=true).
